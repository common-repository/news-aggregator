  ...
  public function settingsPage() {
    ...
    ?>
        ...
        <div id="news-aggregator-implementation">
          ...
          <p><strong>To add news from any of our other 15+ categories, consider one of our <a href="<?php echo esc_url( 'https://www.plnia.com/pricing/' ); ?>" target="_blank" rel="noopener">paid plans</a></strong>. All paid plans include a <a href="<?php echo esc_url( 'https://www.plnia.com/pricing/' ); ?>" target="_blank" rel="noopener">free 7-day trial</a>.</p>
          <br />
